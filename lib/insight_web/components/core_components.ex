defmodule InsightWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InsightWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InsightWeb.Gettext, "errors", msg, opts)
    end
  end
